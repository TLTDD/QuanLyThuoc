                    ...
                    foreach ($data_tintuc as $item) { ?>
                        <div class="col-12 col-md-12 col-12">
                            <div class="item_blog_base">
                                <a href="?act=news&chitiet=<?= $item['idTinTuc']?>" class="video_play thumb" data-toggle="modal" data-target="#myModalYoutube" title="<?= $item['TieuDe'];?>">
                                    <img src="./public/images/<?= $item['HinhAnh'];?>">
                                </a>
                                <div class="content_blog clearfix">
                                    <h3><a href="?act=news&chitiet=<?= $item['idTinTuc']?>" class="a-title"><?= $item['TieuDe'];?></a></h3>
